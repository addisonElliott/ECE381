...
export LoadConfigTBL_spi_sram_Bank1
export LoadConfigTBL_spi_sram_Bank0
...
;       Instance name SPIM, Block Name SPIM(DCB23)
	...
	db		4dh, d6h		;SPIM_INPUT_REG    (DCB23IN)
...
LoadConfigTBL_spi_sram_Ordered:
;  Ordered Global Register values
	...
	M8C_SetBank0
	mov	reg[07h], 9fh		; Port_1_DriveMode_2 register (PRT1DM2)
	mov	reg[06h], 78h		; Port_1_GlobalSelect register (PRT1GS)
	M8C_SetBank1
