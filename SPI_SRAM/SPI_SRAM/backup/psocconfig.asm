...
export LoadConfig_spi_sram
export _LoadConfig_spi_sram
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_spi_sram
	lcall	LoadConfigTBL_spi_sram_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration spi_sram
;
;    Load configuration registers for spi_sram.
...
_LoadConfig_spi_sram:
 LoadConfig_spi_sram:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_spi_sram_Bank0
    mov     X, <LoadConfigTBL_spi_sram_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_spi_sram_Bank1
    mov     X, <LoadConfigTBL_spi_sram_Bank1
