...
export LoadConfigTBL_datasheet_lcd_display_Bank1
export LoadConfigTBL_datasheet_lcd_display_Bank0
export LoadConfigTBL_datasheet_lcd_display_Ordered
AREA lit(rom, rel)
LoadConfigTBL_datasheet_lcd_display_Bank0:
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_datasheet_lcd_display_Bank1:
;  Instance name LCD, User Module LCD
...
LoadConfigTBL_datasheet_lcd_display_Ordered:
