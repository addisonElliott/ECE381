...
export LoadConfig_datasheet_lcd_display
export _LoadConfig_datasheet_lcd_display
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_datasheet_lcd_display
	lcall	LoadConfigTBL_datasheet_lcd_display_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration datasheet_lcd_display
;
;    Load configuration registers for datasheet_lcd_display.
...
;               CUR_PP
;
_LoadConfig_datasheet_lcd_display:
 LoadConfig_datasheet_lcd_display:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_datasheet_lcd_display_Bank0
    mov     X, <LoadConfigTBL_datasheet_lcd_display_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_datasheet_lcd_display_Bank1
    mov     X, <LoadConfigTBL_datasheet_lcd_display_Bank1
