// ======================================================================
// PS2Keyboard.v generated from TopDesign.cysch
// 04/27/2016 at 20:49
...
`ifdef WARP
`define CY_BLK_DIR "C:\Users\addis\Documents\PSoC Creator\Workspace02\PS2Keyboard.cydsn\PS2_Core"
`include "C:\Users\addis\Documents\PSoC Creator\Workspace02\PS2Keyboard.cydsn\PS2_Core\PS2_Core.v"
`else
`define CY_BLK_DIR "C:\Users\addis\Documents\PSoC Creator\Workspace02\PS2Keyboard.cydsn\PS2_Core"
`include "C:\Users\addis\Documents\PSoC Creator\Workspace02\PS2Keyboard.cydsn\PS2_Core\PS2_Core.v"
`endif
...
// PS2(CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=PS2, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PS2, CY_INSTANCE_SHORT_NAME=PS2, CY_MAJOR_VERSION=0, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP1, INSTANCE_NAME=PS2, )
module PS2_2 (
    clock,
    ps2_data,
    clock_10us,
    ...
    PS2_Core PS2_Core (
        .wr(Net_1284),
        .data_out(Net_1316[7:0]),
        .ps2_data_out(ps2_data_hw),
    ...
    CyControlReg_v1_80 controlReg (
        .control_1(Net_1414),
        .control_2(ps2_data_sw),
        .control_3(ps2_clock_out),
        .control_0(Net_1284),
        .control_4(ps2_data_ctrl),
        .control_5(Net_1773),
        .control_6(Net_1774),
        .control_7(Net_1775),
        .clock(1'b0),
        .reset(1'b0));
    defparam controlReg.Bit0Mode = 0;
    defparam controlReg.Bit1Mode = 0;
    defparam controlReg.Bit2Mode = 0;
    defparam controlReg.Bit3Mode = 0;
    defparam controlReg.Bit4Mode = 0;
    defparam controlReg.Bit5Mode = 0;
    defparam controlReg.Bit6Mode = 0;
    defparam controlReg.Bit7Mode = 0;
    defparam controlReg.BitValue = 0;
    defparam controlReg.BusDisplay = 0;
    defparam controlReg.ExtrReset = 0;
    defparam controlReg.NumOutputs = 5;
    ...
    defparam statusReg.NumInputs = 2;

    CyStatusReg_v1_90 stateReg (
        .status_0(1'b0),
        .status_1(1'b0),
        .status_2(1'b0),
        .status_3(1'b0),
        ...
        .status_7(1'b0),
        .intr(Net_1447),
        .status_bus(Net_1448[7:0]));
    defparam stateReg.Bit0Mode = 0;
    defparam stateReg.Bit1Mode = 0;
    defparam stateReg.Bit2Mode = 0;
    defparam stateReg.Bit3Mode = 0;
    defparam stateReg.Bit4Mode = 0;
    defparam stateReg.Bit5Mode = 0;
    defparam stateReg.Bit6Mode = 0;
    defparam stateReg.Bit7Mode = 0;
    defparam stateReg.BusDisplay = 1;
    defparam stateReg.Interrupt = 0;
    defparam stateReg.MaskValue = 0;
    defparam stateReg.NumInputs = 8;

    CyControlReg_v1_80 dataIn (
        .control_1(Net_1264),
        .control_2(Net_1265),
        .control_3(Net_1266),
        .control_0(Net_1267),
        ...
        .clock(1'b0),
        .reset(1'b0),
        .control_bus(Net_660[7:0]));
    defparam dataIn.Bit0Mode = 0;
    defparam dataIn.Bit1Mode = 0;
    defparam dataIn.Bit2Mode = 0;
    defparam dataIn.Bit3Mode = 0;
    defparam dataIn.Bit4Mode = 0;
    defparam dataIn.Bit5Mode = 0;
    defparam dataIn.Bit6Mode = 0;
    defparam dataIn.Bit7Mode = 0;
    defparam dataIn.BitValue = 0;
    defparam dataIn.BusDisplay = 1;
    defparam dataIn.ExtrReset = 0;
    defparam dataIn.NumOutputs = 8;

    CyStatusReg_v1_90 dataOut (
        .status_0(1'b0),
        .status_1(1'b0),
        .status_2(1'b0),
        .status_3(1'b0),
        ...
        .status_7(1'b0),
        .intr(Net_1282),
        .status_bus(Net_1316[7:0]));
    defparam dataOut.Bit0Mode = 0;
    defparam dataOut.Bit1Mode = 0;
    defparam dataOut.Bit2Mode = 0;
    defparam dataOut.Bit3Mode = 0;
    defparam dataOut.Bit4Mode = 0;
    defparam dataOut.Bit5Mode = 0;
    defparam dataOut.Bit6Mode = 0;
    defparam dataOut.Bit7Mode = 0;
    defparam dataOut.BusDisplay = 1;
    defparam dataOut.Interrupt = 0;
    defparam dataOut.MaskValue = 0;
    defparam dataOut.NumInputs = 8;
	...
	assign tmpOE__bufoe_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{Net_1772} : {Net_1772};

    // -- Mux start --
    if (1)
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(ps2_data_sw or ps2_data_hw or ps2_data_ctrl)
        begin
            case (ps2_data_ctrl)
                1'b0 :  tmp__mux_1_reg = ps2_data_sw;
                1'b1 :  tmp__mux_1_reg = ps2_data_hw;
            endcase
        end
        assign Net_1630 = tmp__mux_1_reg;
    end
    // -- Mux end --
	...
	assign tmpOE__bufoe_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{Net_1778} : {Net_1778};
...
module top ;
	...
	cy_clock_v1_0
		#(.id("4e63f461-9292-4a06-a0df-34ecf78aceb0"),
    ...
    UART_v2_50_0 UART (
        ...
        .reset(Net_1891),
        .rx(Net_970),
        .tx_interrupt(Net_1892),
        .rx_interrupt(Net_1893),
        .tx_data(Net_1894),
        .tx_clk(Net_1895),
        .rx_data(Net_1896),
        .rx_clk(Net_1897));
    ...
    assign Net_1891 = 1'h0;


	cy_clock_v1_0
		#(.id("94c5795b-28ed-45e9-86aa-8f8651a702b8"),
	...
	wire [0:0] tmpOE__ps2_data_net;
	wire [0:0] tmpFB_0__ps2_data_net;
	wire [0:0] tmpINTERRUPT_0__ps2_data_net;
	electrical [0:0] tmpSIOVREF__ps2_data_net;

	cy_psoc3_pins_v1_10
		#(.id("1008c28c-2855-4f1b-b8a1-5c9d05c2554d"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ps2_data
		 (.oe(tmpOE__ps2_data_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ps2_data_net[0:0]}),
		  .io({Net_2688}),
		  .siovref(tmpSIOVREF__ps2_data_net),
		  .interrupt({tmpINTERRUPT_0__ps2_data_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ps2_data_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ps2_clock_net;
	wire [0:0] tmpFB_0__ps2_clock_net;
	wire [0:0] tmpINTERRUPT_0__ps2_clock_net;
	electrical [0:0] tmpSIOVREF__ps2_clock_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("264be2d3-9481-494b-8d9c-c1905a45e9cc"),
		  ...
		  .input_buffer_sel(2'b00))
		ps2_clock
		 (.oe(tmpOE__ps2_clock_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ps2_clock_net[0:0]}),
		  .io({Net_2689}),
		  .siovref(tmpSIOVREF__ps2_clock_net),
		  .interrupt({tmpINTERRUPT_0__ps2_clock_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ps2_clock_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
