...
*********************************************************************/
const uint8 CYCODE USBFS_STRING_DESCRIPTORS[187u] = {
/*********************************************************************
...
/*********************************************************************
* String Descriptor: "Addison Elliott"
*********************************************************************/
/* Descriptor Length                       */ 0x20u,
/* DescriptorType: STRING                  */ 0x03u,
 (uint8)'A', 0u,(uint8)'d', 0u,(uint8)'d', 0u,(uint8)'i', 0u,(uint8)'s', 0u,
 (uint8)'o', 0u,(uint8)'n', 0u,(uint8)' ', 0u,(uint8)'E', 0u,(uint8)'l', 0u,
 (uint8)'l', 0u,(uint8)'i', 0u,(uint8)'o', 0u,(uint8)'t', 0u,(uint8)'t', 0u,
/*********************************************************************
* String Descriptor: "PS/2 Keyboard"
*********************************************************************/
/* Descriptor Length                       */ 0x1Cu,
/* DescriptorType: STRING                  */ 0x03u,
 (uint8)'P', 0u,(uint8)'S', 0u,(uint8)'/', 0u,(uint8)'2', 0u,(uint8)' ', 0u,
...
*********************************************************************/
const uint8 CYCODE USBFS_HIDREPORT_DESCRIPTOR1[67u] = {
...
*********************************************************************/
T_USBFS_XFER_STATUS_BLOCK USBFS_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_FEATURE_RPT_SCB;
uint8 USBFS_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_FEATURE_BUF[
            USBFS_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_FEATURE_BUF_SIZE];

/*********************************************************************
* HID Feature Report TD Table
*********************************************************************/
const T_USBFS_TD CYCODE USBFS_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_FEATURE_RPT_TABLE[1u] = {
    {USBFS_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_FEATURE_BUF_SIZE,
    &USBFS_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_FEATURE_BUF[0u],
    &USBFS_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_FEATURE_RPT_SCB},
};
/*********************************************************************
...
const T_USBFS_LUT CYCODE USBFS_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_TABLE[5u] = {
    ...
    {0x00u,    NULL},
    {0x00u,     &USBFS_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_FEATURE_RPT_TABLE},
