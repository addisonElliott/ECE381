...
export LoadConfigTBL_ps2bitbang_Bank1
export LoadConfigTBL_ps2bitbang_Bank0
export LoadConfigTBL_ps2bitbang_Ordered
AREA lit(rom, rel)
LoadConfigTBL_ps2bitbang_Bank0:
;  Instance name LCD, User Module LCD
;  Instance name PORT1SHADOWREG, User Module SHADOWREGS
;  Instance name PS2DigBuf, User Module DigBuf
;       Instance name PS2DigBuf, Block Name DigBuf(DBB10)
	db		33h, 03h		;PS2DigBuf_CONTROL_REG(DBB10CR0)
	db		31h, 00h		;PS2DigBuf_DATA_1_REG(DBB10DR1)
	db		32h, 00h		;PS2DigBuf_DATA_2_REG(DBB10DR2)
;  Instance name PS2OneShot, User Module OneShot
;       Instance name PS2OneShot, Block Name OneShot8(DBB11)
	db		37h, 00h		;PS2OneShot_CONTROL_REG(DBB11CR0)
	db		35h, 00h		;PS2OneShot_POLY_REG   (DBB11DR1)
	db		36h, 00h		;PS2OneShot_SEED_REG   (DBB11DR2)
;  Instance name PWM8LED, User Module PWM8
;       Instance name PWM8LED, Block Name PWM8(DBB20)
	db		43h, 00h		;PWM8LED_CONTROL_REG(DBB20CR0)
	db		41h, ffh		;PWM8LED_PERIOD_REG(DBB20DR1)
	db		42h, 7fh		;PWM8LED_COMPARE_REG(DBB20DR2)
;  Instance name PWMPiano1, User Module PWM16
;       Instance name PWMPiano1, Block Name PWM16_LSB(DCB22)
	db		4bh, 00h		;PWMPiano1_CONTROL_LSB_REG(DCB22CR0)
	db		49h, 00h		;PWMPiano1_PERIOD_LSB_REG(DCB22DR1)
	db		4ah, 00h		;PWMPiano1_COMPARE_LSB_REG(DCB22DR2)
;       Instance name PWMPiano1, Block Name PWM16_MSB(DCB23)
	db		4fh, 00h		;PWMPiano1_CONTROL_MSB_REG(DCB23CR0)
	db		4dh, 00h		;PWMPiano1_PERIOD_MSB_REG(DCB23DR1)
	db		4eh, 00h		;PWMPiano1_COMPARE_MSB_REG(DCB23DR2)
;  Instance name PWMPiano2, User Module PWM16
;       Instance name PWMPiano2, Block Name PWM16_LSB(DBB00)
	db		23h, 00h		;PWMPiano2_CONTROL_LSB_REG(DBB00CR0)
	db		21h, 00h		;PWMPiano2_PERIOD_LSB_REG(DBB00DR1)
	db		22h, 00h		;PWMPiano2_COMPARE_LSB_REG(DBB00DR2)
;       Instance name PWMPiano2, Block Name PWM16_MSB(DBB01)
	db		27h, 00h		;PWMPiano2_CONTROL_MSB_REG(DBB01CR0)
	db		25h, 00h		;PWMPiano2_PERIOD_MSB_REG(DBB01DR1)
	db		26h, 00h		;PWMPiano2_COMPARE_MSB_REG(DBB01DR2)
;  Instance name PWMPiano3, User Module PWM16
;       Instance name PWMPiano3, Block Name PWM16_LSB(DCB02)
	db		2bh, 00h		;PWMPiano3_CONTROL_LSB_REG(DCB02CR0)
	db		29h, 00h		;PWMPiano3_PERIOD_LSB_REG(DCB02DR1)
	db		2ah, 00h		;PWMPiano3_COMPARE_LSB_REG(DCB02DR2)
;       Instance name PWMPiano3, Block Name PWM16_MSB(DCB03)
	db		2fh, 00h		;PWMPiano3_CONTROL_MSB_REG(DCB03CR0)
	db		2dh, 00h		;PWMPiano3_PERIOD_MSB_REG(DCB03DR1)
	db		2eh, 00h		;PWMPiano3_COMPARE_MSB_REG(DCB03DR2)
;  Instance name TenMicroSecTimer, User Module Timer16
;       Instance name TenMicroSecTimer, Block Name TIMER16_LSB(DCB12)
	db		3bh, 00h		;TenMicroSecTimer_CONTROL_LSB_REG(DCB12CR0)
	db		39h, 00h		;TenMicroSecTimer_PERIOD_LSB_REG(DCB12DR1)
	db		3ah, 00h		;TenMicroSecTimer_COMPARE_LSB_REG(DCB12DR2)
;       Instance name TenMicroSecTimer, Block Name TIMER16_MSB(DCB13)
	db		3fh, 04h		;TenMicroSecTimer_CONTROL_MSB_REG(DCB13CR0)
	db		3dh, 00h		;TenMicroSecTimer_PERIOD_MSB_REG(DCB13DR1)
	db		3eh, 00h		;TenMicroSecTimer_COMPARE_MSB_REG(DCB13DR2)
...
;  Instance name UARTClock, User Module Counter16
;       Instance name UARTClock, Block Name CNTR16_LSB(DBB30)
	db		53h, 00h		;UARTClock_CONTROL_LSB_REG(DBB30CR0)
	db		51h, 33h		;UARTClock_PERIOD_LSB_REG(DBB30DR1)
	db		52h, 19h		;UARTClock_COMPARE_LSB_REG(DBB30DR2)
;       Instance name UARTClock, Block Name CNTR16_MSB(DBB31)
	db		57h, 00h		;UARTClock_CONTROL_MSB_REG(DBB31CR0)
	db		55h, 00h		;UARTClock_PERIOD_MSB_REG(DBB31DR1)
	db		56h, 00h		;UARTClock_COMPARE_MSB_REG(DBB31DR2)
;  Global Register values Bank 0
	...
	db		c5h, 41h		; Row_2_OutputDrive_0 register (RDI2SRO0)
	...
	db		ffh
LoadConfigTBL_ps2bitbang_Bank1:
;  Instance name LCD, User Module LCD
;  Instance name PORT1SHADOWREG, User Module SHADOWREGS
;  Instance name PS2DigBuf, User Module DigBuf
;       Instance name PS2DigBuf, Block Name DigBuf(DBB10)
	db		30h, a2h		;PS2DigBuf_FUNC_REG(DBB10FN)
	db		31h, e0h		;PS2DigBuf_INPUT_REG(DBB10IN)
	db		32h, 40h		;PS2DigBuf_OUTPUT_REG(DBB10OU)
;  Instance name PS2OneShot, User Module OneShot
;       Instance name PS2OneShot, Block Name OneShot8(DBB11)
	db		34h, 22h		;PS2OneShot_FUNC_REG   (DBB11FN)
	db		35h, e1h		;PS2OneShot_INPUT_REG  (DBB11IN)
	db		36h, 40h		;PS2OneShot_OUTPUT_REG (DBB11OU)
;  Instance name PWM8LED, User Module PWM8
;       Instance name PWM8LED, Block Name PWM8(DBB20)
	db		40h, 21h		;PWM8LED_FUNC_REG(DBB20FN)
	db		41h, 11h		;PWM8LED_INPUT_REG(DBA20IN)
	db		42h, 45h		;PWM8LED_OUTPUT_REG(DBA20OU)
;  Instance name PWMPiano1, User Module PWM16
;       Instance name PWMPiano1, Block Name PWM16_LSB(DCB22)
	db		48h, 01h		;PWMPiano1_FUNC_LSB_REG(DCB22FN)
	db		49h, 15h		;PWMPiano1_INPUT_LSB_REG(DCB22IN)
	db		4ah, 40h		;PWMPiano1_OUTPUT_LSB_REG(DCB22OU)
;       Instance name PWMPiano1, Block Name PWM16_MSB(DCB23)
	db		4ch, 21h		;PWMPiano1_FUNC_MSB_REG(DCB23FN)
	db		4dh, 35h		;PWMPiano1_INPUT_MSB_REG(DCB23IN)
	db		4eh, 44h		;PWMPiano1_OUTPUT_MSB_REG(DCB23OU)
;  Instance name PWMPiano2, User Module PWM16
;       Instance name PWMPiano2, Block Name PWM16_LSB(DBB00)
	db		20h, 01h		;PWMPiano2_FUNC_LSB_REG(DBB00FN)
	db		21h, 15h		;PWMPiano2_INPUT_LSB_REG(DBB00IN)
	db		22h, 40h		;PWMPiano2_OUTPUT_LSB_REG(DBB00OU)
;       Instance name PWMPiano2, Block Name PWM16_MSB(DBB01)
	db		24h, 21h		;PWMPiano2_FUNC_MSB_REG(DBB01FN)
	db		25h, 35h		;PWMPiano2_INPUT_MSB_REG(DBB01IN)
	db		26h, 45h		;PWMPiano2_OUTPUT_MSB_REG(DBB01OU)
;  Instance name PWMPiano3, User Module PWM16
;       Instance name PWMPiano3, Block Name PWM16_LSB(DCB02)
	db		28h, 01h		;PWMPiano3_FUNC_LSB_REG(DCB02FN)
	db		29h, 15h		;PWMPiano3_INPUT_LSB_REG(DCB02IN)
	db		2ah, 40h		;PWMPiano3_OUTPUT_LSB_REG(DCB02OU)
;       Instance name PWMPiano3, Block Name PWM16_MSB(DCB03)
	db		2ch, 21h		;PWMPiano3_FUNC_MSB_REG(DCB03FN)
	db		2dh, 35h		;PWMPiano3_INPUT_MSB_REG(DCB03IN)
	db		2eh, 46h		;PWMPiano3_OUTPUT_MSB_REG(DCB03OU)
;  Instance name TenMicroSecTimer, User Module Timer16
;       Instance name TenMicroSecTimer, Block Name TIMER16_LSB(DCB12)
	db		38h, 10h		;TenMicroSecTimer_FUNC_LSB_REG(DCB12FN)
	db		39h, 01h		;TenMicroSecTimer_INPUT_LSB_REG(DCB12IN)
	db		3ah, 40h		;TenMicroSecTimer_OUTPUT_LSB_REG(DCB12OU)
;       Instance name TenMicroSecTimer, Block Name TIMER16_MSB(DCB13)
	db		3ch, 30h		;TenMicroSecTimer_FUNC_MSB_REG(DCB13FN)
	db		3dh, 31h		;TenMicroSecTimer_INPUT_MSB_REG(DCB13IN)
	db		3eh, 40h		;TenMicroSecTimer_OUTPUT_MSB_REG(DCB13OU)
;  Instance name UART, User Module UART
;       Instance name UART, Block Name RX(DCB33)
	db		5ch, 05h		;UART_RX_FUNC_REG   (DCB33FN)
	db		5dh, e2h		;UART_RX_INPUT_REG  (DCB33IN)
	db		5eh, 40h		;UART_RX_OUTPUT_REG (DCB33OU)
;       Instance name UART, Block Name TX(DCB32)
	db		58h, 0dh		;UART_TX_FUNC_REG   (DCB32FN)
	db		59h, 02h		;UART_TX_INPUT_REG  (DCB32IN)
	db		5ah, 47h		;UART_TX_OUTPUT_REG (DCB32OU)
;  Instance name UARTClock, User Module Counter16
;       Instance name UARTClock, Block Name CNTR16_LSB(DBB30)
	db		50h, 01h		;UARTClock_FUNC_LSB_REG(DBB30FN)
	db		51h, 10h		;UARTClock_INPUT_LSB_REG(DBB30IN)
	db		52h, c0h		;UARTClock_OUTPUT_LSB_REG(DBB30OU)
;       Instance name UARTClock, Block Name CNTR16_MSB(DBB31)
	db		54h, 61h		;UARTClock_FUNC_MSB_REG(DBB31FN)
	db		55h, 30h		;UARTClock_INPUT_MSB_REG(DBB31IN)
	db		56h, c0h		;UARTClock_OUTPUT_MSB_REG(DBB31OU)
...
LoadConfigTBL_ps2bitbang_Ordered:
;  Ordered Global Register values
	...
	mov	reg[04h], 18h		; Port_1_Data register (PRT1DR)
	M8C_SetBank1
	mov	reg[04h], 3bh		; Port_1_DriveMode_0 register (PRT1DM0)
	mov	reg[05h], dch		; Port_1_DriveMode_1 register (PRT1DM1)
	M8C_SetBank0
	mov	reg[07h], 98h		; Port_1_DriveMode_2 register (PRT1DM2)
	mov	reg[06h], 46h		; Port_1_GlobalSelect register (PRT1GS)
	M8C_SetBank1
