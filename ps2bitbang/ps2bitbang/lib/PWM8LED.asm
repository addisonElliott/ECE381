...
;  Global Symbols
;-----------------------------------------------
export  PWM8LED_EnableInt
export _PWM8LED_EnableInt
export  PWM8LED_DisableInt
export _PWM8LED_DisableInt
export  PWM8LED_Start
export _PWM8LED_Start
export  PWM8LED_Stop
export _PWM8LED_Stop
export  PWM8LED_WritePeriod
export _PWM8LED_WritePeriod
export  PWM8LED_WritePulseWidth
export _PWM8LED_WritePulseWidth
export  PWM8LED_bReadPulseWidth
export _PWM8LED_bReadPulseWidth
export  PWM8LED_bReadCounter
export _PWM8LED_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bPWM8LED_ReadPulseWidth    ; deprecated
export _bPWM8LED_ReadPulseWidth    ; deprecated
export  bPWM8LED_ReadCounter       ; deprecated
export _bPWM8LED_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8LED_EnableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8LED_DisableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8LED_WritePeriod
;
;  DESCRIPTION:
...
;
 PWM8LED_WritePeriod:
_PWM8LED_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8LED_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8LED_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8LED_WritePulseWidth:
_PWM8LED_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8LED_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8LED_bReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8LED_bReadPulseWidth:
_PWM8LED_bReadPulseWidth:
 bPWM8LED_ReadPulseWidth:                        ; this name deprecated
_bPWM8LED_ReadPulseWidth:                        ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[PWM8LED_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8LED_bReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 PWM8LED_bReadCounter:
_PWM8LED_bReadCounter:
 bPWM8LED_ReadCounter:                           ; this name deprecated
_bPWM8LED_ReadCounter:                           ; this name deprecated
   ...
   mov   A, reg[PWM8LED_COMPARE_REG]             ; Save the Compare register on the stack
   push  A                                       ;
   PWM8LED_Stop_M                                ; Disable (stop) the PWM
   M8C_SetBank1                                  ;
   mov   A, reg[PWM8LED_INPUT_REG]               ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[PWM8LED_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[PWM8LED_COUNTER_REG]             ; DR2 <- DR0
   mov   A, reg[PWM8LED_COMPARE_REG]             ; Stash the Count on the stack
   ...
   mov   reg[PWM8LED_INPUT_REG], A               ;
   M8C_SetBank0                                  ;
   PWM8LED_Start_M                               ;   then re-enable the PWM.
