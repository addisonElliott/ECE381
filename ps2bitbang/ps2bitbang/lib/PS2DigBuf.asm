...
include "m8c.inc"
include "memory.inc"
include "PS2DigBuf.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  PS2DigBuf_EnableInt
export _PS2DigBuf_EnableInt
export  PS2DigBuf_DisableInt
export _PS2DigBuf_DisableInt
export  PS2DigBuf_Start
export _PS2DigBuf_Start
export  PS2DigBuf_Stop
export _PS2DigBuf_Stop
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PS2DigBuf_EnableInt
;
;  DESCRIPTION:
...
;
 PS2DigBuf_EnableInt:
_PS2DigBuf_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1   
   PS2DigBuf_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PS2DigBuf_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 PS2DigBuf_DisableInt:
_PS2DigBuf_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1   
   PS2DigBuf_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
