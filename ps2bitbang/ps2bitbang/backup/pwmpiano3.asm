...
include "m8c.inc"
include "PWMPiano3.inc"
include "memory.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  PWMPiano3_EnableInt
export _PWMPiano3_EnableInt
export  PWMPiano3_DisableInt
export _PWMPiano3_DisableInt
export  PWMPiano3_Start
export _PWMPiano3_Start
export  PWMPiano3_Stop
export _PWMPiano3_Stop
export  PWMPiano3_WritePeriod
export _PWMPiano3_WritePeriod
export  PWMPiano3_WritePulseWidth
export _PWMPiano3_WritePulseWidth
export  PWMPiano3_wReadPulseWidth
export _PWMPiano3_wReadPulseWidth
export  PWMPiano3_wReadCounter
export _PWMPiano3_wReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  wPWMPiano3_ReadPulseWidth    ; deprecated
export _wPWMPiano3_ReadPulseWidth    ; deprecated
export  wPWMPiano3_ReadCounter       ; deprecated
export _wPWMPiano3_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWMPiano3_EnableInt
;
;  DESCRIPTION:
...
;
 PWMPiano3_EnableInt:
_PWMPiano3_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   PWMPiano3_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWMPiano3_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 PWMPiano3_DisableInt:
_PWMPiano3_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   PWMPiano3_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWMPiano3_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 PWMPiano3_WritePeriod:
_PWMPiano3_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWMPiano3_PERIOD_LSB_REG], A
   mov   A, X
   mov   reg[PWMPiano3_PERIOD_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWMPiano3_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWMPiano3_WritePulseWidth:
_PWMPiano3_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWMPiano3_COMPARE_LSB_REG], A
   mov   A, X
   mov   reg[PWMPiano3_COMPARE_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWMPiano3_wReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWMPiano3_wReadPulseWidth:
_PWMPiano3_wReadPulseWidth:
 wPWMPiano3_ReadPulseWidth:                      ; this name deprecated
_wPWMPiano3_ReadPulseWidth:                      ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[PWMPiano3_COMPARE_MSB_REG]
   mov   X, A
   mov   A, reg[PWMPiano3_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWMPiano3_wReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 PWMPiano3_wReadCounter:
_PWMPiano3_wReadCounter:
 wPWMPiano3_ReadCounter:                         ; this name deprecated
_wPWMPiano3_ReadCounter:                         ; this name deprecated
   ...
   mov   A, reg[PWMPiano3_COMPARE_MSB_REG]       ; Save the Compare register on the stack
   push  A                                          ;
   mov   A, reg[PWMPiano3_COMPARE_LSB_REG]       ;
   push  A                                          ;  -stack frame now 2 bytes-
   PWMPiano3_Stop_M                              ; Disable the PWM function
   M8C_SetBank1                                     ;
   mov   A, reg[PWMPiano3_INPUT_LSB_REG]         ; save the LSB clock input setting
   push  A                                          ;   on the stack (now 3 bytes) and ...
                                                    ;   hold the clock low:
   mov   reg[PWMPiano3_INPUT_LSB_REG], INPUT_REG_NULL
   M8C_SetBank0                                     ; Extract the Count via DR2 register
   mov   A, reg[PWMPiano3_COUNTER_MSB_REG]       ; DR2 <- DR0 (in the MSB block)
   mov   A, reg[PWMPiano3_COMPARE_MSB_REG]       ; Stash the Count MSB on the stack
   push  A                                          ;  -stack frame is now 4 bytes
   mov   A, reg[PWMPiano3_COUNTER_LSB_REG]       ; DR2 <- DR0 (in the LSB block)
   mov   A, reg[PWMPiano3_COMPARE_LSB_REG]       ; Stash the Count LSB on the stack
   ...
   mov   reg[PWMPiano3_INPUT_LSB_REG], A         ;    and restore it
   M8C_SetBank0                                     ;
   PWMPiano3_Start_M                             ; Now re-enable the PWM function
