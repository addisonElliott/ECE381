...
include "m8c.inc"
include "PWMPiano1.inc"
include "memory.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  PWMPiano1_EnableInt
export _PWMPiano1_EnableInt
export  PWMPiano1_DisableInt
export _PWMPiano1_DisableInt
export  PWMPiano1_Start
export _PWMPiano1_Start
export  PWMPiano1_Stop
export _PWMPiano1_Stop
export  PWMPiano1_WritePeriod
export _PWMPiano1_WritePeriod
export  PWMPiano1_WritePulseWidth
export _PWMPiano1_WritePulseWidth
export  PWMPiano1_wReadPulseWidth
export _PWMPiano1_wReadPulseWidth
export  PWMPiano1_wReadCounter
export _PWMPiano1_wReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  wPWMPiano1_ReadPulseWidth    ; deprecated
export _wPWMPiano1_ReadPulseWidth    ; deprecated
export  wPWMPiano1_ReadCounter       ; deprecated
export _wPWMPiano1_ReadCounter       ; deprecated
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWMPiano1_EnableInt
;
;  DESCRIPTION:
...
;
 PWMPiano1_EnableInt:
_PWMPiano1_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   PWMPiano1_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWMPiano1_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 PWMPiano1_DisableInt:
_PWMPiano1_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   PWMPiano1_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWMPiano1_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 PWMPiano1_WritePeriod:
_PWMPiano1_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWMPiano1_PERIOD_LSB_REG], A
   mov   A, X
   mov   reg[PWMPiano1_PERIOD_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWMPiano1_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWMPiano1_WritePulseWidth:
_PWMPiano1_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWMPiano1_COMPARE_LSB_REG], A
   mov   A, X
   mov   reg[PWMPiano1_COMPARE_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWMPiano1_wReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWMPiano1_wReadPulseWidth:
_PWMPiano1_wReadPulseWidth:
 wPWMPiano1_ReadPulseWidth:                      ; this name deprecated
_wPWMPiano1_ReadPulseWidth:                      ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[PWMPiano1_COMPARE_MSB_REG]
   mov   X, A
   mov   A, reg[PWMPiano1_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWMPiano1_wReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 PWMPiano1_wReadCounter:
_PWMPiano1_wReadCounter:
 wPWMPiano1_ReadCounter:                         ; this name deprecated
_wPWMPiano1_ReadCounter:                         ; this name deprecated
   ...
   mov   A, reg[PWMPiano1_COMPARE_MSB_REG]       ; Save the Compare register on the stack
   push  A                                          ;
   mov   A, reg[PWMPiano1_COMPARE_LSB_REG]       ;
   push  A                                          ;  -stack frame now 2 bytes-
   PWMPiano1_Stop_M                              ; Disable the PWM function
   M8C_SetBank1                                     ;
   mov   A, reg[PWMPiano1_INPUT_LSB_REG]         ; save the LSB clock input setting
   push  A                                          ;   on the stack (now 3 bytes) and ...
                                                    ;   hold the clock low:
   mov   reg[PWMPiano1_INPUT_LSB_REG], INPUT_REG_NULL
   M8C_SetBank0                                     ; Extract the Count via DR2 register
   mov   A, reg[PWMPiano1_COUNTER_MSB_REG]       ; DR2 <- DR0 (in the MSB block)
   mov   A, reg[PWMPiano1_COMPARE_MSB_REG]       ; Stash the Count MSB on the stack
   push  A                                          ;  -stack frame is now 4 bytes
   mov   A, reg[PWMPiano1_COUNTER_LSB_REG]       ; DR2 <- DR0 (in the LSB block)
   mov   A, reg[PWMPiano1_COMPARE_LSB_REG]       ; Stash the Count LSB on the stack
   ...
   mov   reg[PWMPiano1_INPUT_LSB_REG], A         ;    and restore it
   M8C_SetBank0                                     ;
   PWMPiano1_Start_M                             ; Now re-enable the PWM function
