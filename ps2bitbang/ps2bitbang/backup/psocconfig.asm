...
export LoadConfig_ps2bitbang
export _LoadConfig_ps2bitbang
...
_LoadConfigInit:
 LoadConfigInit:
	...
	mov		[Port_1_Data_SHADE], 18h
	mov		[Port_2_Data_SHADE], 0h
	mov		[Port_2_DriveMode_0_SHADE], ffh
	mov		[Port_2_DriveMode_1_SHADE], 0h

	lcall	LoadConfig_ps2bitbang
	lcall	LoadConfigTBL_ps2bitbang_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration ps2bitbang
;
;    Load configuration registers for ps2bitbang.
...
;               CUR_PP
;
_LoadConfig_ps2bitbang:
 LoadConfig_ps2bitbang:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_ps2bitbang_Bank0
    mov     X, <LoadConfigTBL_ps2bitbang_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_ps2bitbang_Bank1
    mov     X, <LoadConfigTBL_ps2bitbang_Bank1
