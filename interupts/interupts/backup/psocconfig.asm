...
export LoadConfig_interupts
export _LoadConfig_interupts
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_interupts
	lcall	LoadConfigTBL_interupts_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration interupts
;
;    Load configuration registers for interupts.
...
;               CUR_PP
;
_LoadConfig_interupts:
 LoadConfig_interupts:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_interupts_Bank0
    mov     X, <LoadConfigTBL_interupts_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_interupts_Bank1
    mov     X, <LoadConfigTBL_interupts_Bank1
