...
export LoadConfigTBL_interupts_Bank1
export LoadConfigTBL_interupts_Bank0
export LoadConfigTBL_interupts_Ordered
AREA lit(rom, rel)
LoadConfigTBL_interupts_Bank0:
...
LoadConfigTBL_interupts_Ordered:
