...
export LoadConfigTBL_opticalencoder_lcd_display_Bank1
export LoadConfigTBL_opticalencoder_lcd_display_Bank0
...
LoadConfigTBL_opticalencoder_lcd_display_Ordered:
