...
export LoadConfigTBL_nrf24l01_template_Bank1
export LoadConfigTBL_nrf24l01_template_Bank0
...
;       Instance name SPIM, Block Name SPIM(DCB02)
	...
	db		29h, d5h		;SPIM_INPUT_REG    (DCB02IN)
	db		2ah, 7ch		;SPIM_OUTPUT_REG   (DCB02OU)
;  Instance name SleepTimer, User Module SleepTimer
...
;  Ordered Global Register values
	...
	M8C_SetBank1
	mov	reg[04h], 5ch		; Port_1_DriveMode_0 register (PRT1DM0)
	mov	reg[05h], a3h		; Port_1_DriveMode_1 register (PRT1DM1)
	M8C_SetBank0
	mov	reg[07h], 03h		; Port_1_DriveMode_2 register (PRT1DM2)
	mov	reg[06h], 38h		; Port_1_GlobalSelect register (PRT1GS)
	M8C_SetBank1
