...
#define REF_MUX                0x6     // Ref mux setting
#define REF_MUX_MASK           0x38    // Ref mux setting mask
#define REF_MUX_JUST           0x30    // Ref mux setting justified
...
#define PORT_1_GLOBAL_SELECT   0x38    //Port 1 global select register (PRT1GS)
#define PORT_1_DRIVE_0         0x5c    //Port 1 drive mode 0 register (PRT1DM0)
#define PORT_1_DRIVE_1         0xa3    //Port 1 drive mode 1 register (PRT1DM1)
