...
export LoadConfig_nrf24l01_template
export _LoadConfig_nrf24l01_template
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_nrf24l01_template
	lcall	LoadConfigTBL_nrf24l01_template_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration nrf24l01_template
;
;    Load configuration registers for nrf24l01_template.
...
;               CUR_PP
;
_LoadConfig_nrf24l01_template:
 LoadConfig_nrf24l01_template:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_nrf24l01_template_Bank0
    mov     X, <LoadConfigTBL_nrf24l01_template_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_nrf24l01_template_Bank1
    mov     X, <LoadConfigTBL_nrf24l01_template_Bank1
