...
// Chip Select/Enable Macros
#define CSN_LOW  {CSN_Data_ADDR &= ~CSN_MASK;}
#define CSN_HIGH {CSN_Data_ADDR |=  CSN_MASK;}
#define CE_HIGH {CE_Data_ADDR |=  CE_MASK;}

// NRF Control Bytes for Reading from Selcted Registers.
// The NRF24 write register command is 000A AAAA, where
