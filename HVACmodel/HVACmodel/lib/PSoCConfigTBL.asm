...
;       Instance name MotorDriver, Block Name CNTR16_MSB(DBB11)
	...
	db		35h, 07h		;MotorDriver_PERIOD_MSB_REG(DBB11DR1)
	db		36h, 03h		;MotorDriver_COMPARE_MSB_REG(DBB11DR2)
;  Instance name TempCounter, User Module Counter16
;       Instance name TempCounter, Block Name CNTR16_LSB(DBB00)
	db		23h, 00h		;TempCounter_CONTROL_LSB_REG(DBB00CR0)
	db		21h, ffh		;TempCounter_PERIOD_LSB_REG(DBB00DR1)
	db		22h, 80h		;TempCounter_COMPARE_LSB_REG(DBB00DR2)
;       Instance name TempCounter, Block Name CNTR16_MSB(DBB01)
	db		27h, 00h		;TempCounter_CONTROL_MSB_REG(DBB01CR0)
	db		25h, 7ch		;TempCounter_PERIOD_MSB_REG(DBB01DR1)
	db		26h, 3eh		;TempCounter_COMPARE_MSB_REG(DBB01DR2)
...
;  Instance name MotorDriver, User Module Counter16
;       Instance name MotorDriver, Block Name CNTR16_LSB(DBB10)
	db		30h, 11h		;MotorDriver_FUNC_LSB_REG(DBB10FN)
	db		31h, 16h		;MotorDriver_INPUT_LSB_REG(DBB10IN)
	db		32h, 40h		;MotorDriver_OUTPUT_LSB_REG(DBB10OU)
;       Instance name MotorDriver, Block Name CNTR16_MSB(DBB11)
	db		34h, 39h		;MotorDriver_FUNC_MSB_REG(DBB11FN)
	db		35h, 36h		;MotorDriver_INPUT_MSB_REG(DBB11IN)
	db		36h, 40h		;MotorDriver_OUTPUT_MSB_REG(DBB11OU)
;  Instance name TempCounter, User Module Counter16
;       Instance name TempCounter, Block Name CNTR16_LSB(DBB00)
	db		20h, 11h		;TempCounter_FUNC_LSB_REG(DBB00FN)
	db		21h, 17h		;TempCounter_INPUT_LSB_REG(DBB00IN)
	db		22h, 40h		;TempCounter_OUTPUT_LSB_REG(DBB00OU)
;       Instance name TempCounter, Block Name CNTR16_MSB(DBB01)
	db		24h, 39h		;TempCounter_FUNC_MSB_REG(DBB01FN)
	db		25h, 37h		;TempCounter_INPUT_MSB_REG(DBB01IN)
	db		26h, 40h		;TempCounter_OUTPUT_MSB_REG(DBB01OU)
;  Instance name UART, User Module UART
;       Instance name UART, Block Name RX(DCB03)
