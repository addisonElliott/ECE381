...
#define PORT_0_GLOBAL_SELECT   0x42    //Port 0 global select register (PRT0GS)
#define PORT_0_DRIVE_0         0x42    //Port 0 drive mode 0 register (PRT0DM0)
#define PORT_0_DRIVE_1         0xbd    //Port 0 drive mode 1 register (PRT0DM1)
#define PORT_0_DRIVE_2         0xbd    //Port 0 drive mode 1 register (PRT0DM2)
