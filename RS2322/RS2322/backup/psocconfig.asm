...
export LoadConfig_rs2322
export _LoadConfig_rs2322
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_rs2322
	lcall	LoadConfigTBL_rs2322_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration rs2322
;
;    Load configuration registers for rs2322.
...
_LoadConfig_rs2322:
 LoadConfig_rs2322:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_rs2322_Bank0
    mov     X, <LoadConfigTBL_rs2322_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_rs2322_Bank1
    mov     X, <LoadConfigTBL_rs2322_Bank1
