...
export LoadConfigTBL_wirelesstemperature_Bank1
export LoadConfigTBL_wirelesstemperature_Bank0
export LoadConfigTBL_wirelesstemperature_Ordered
AREA lit(rom, rel)
LoadConfigTBL_wirelesstemperature_Bank0:
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_wirelesstemperature_Bank1:
;  Instance name ADCINC, User Module ADCINC
;       Instance name ADCINC, Block Name ADC1(ASC10)
;       Instance name ADCINC, Block Name ADC2(ASD20)
;       Instance name ADCINC, Block Name PWM(DBB00)
...
LoadConfigTBL_wirelesstemperature_Ordered:
