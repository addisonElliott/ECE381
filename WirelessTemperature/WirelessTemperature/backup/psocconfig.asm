...
export LoadConfig_wirelesstemperature
export _LoadConfig_wirelesstemperature
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_wirelesstemperature
	lcall	LoadConfigTBL_wirelesstemperature_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration wirelesstemperature
;
;    Load configuration registers for wirelesstemperature.
...
;               CUR_PP
;
_LoadConfig_wirelesstemperature:
 LoadConfig_wirelesstemperature:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_wirelesstemperature_Bank0
    mov     X, <LoadConfigTBL_wirelesstemperature_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_wirelesstemperature_Bank1
    mov     X, <LoadConfigTBL_wirelesstemperature_Bank1
