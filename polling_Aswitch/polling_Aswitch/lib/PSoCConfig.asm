...
export LoadConfig_polling_aswitch
export _LoadConfig_polling_aswitch
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_polling_aswitch
	lcall	LoadConfigTBL_polling_aswitch_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration polling_aswitch
;
;    Load configuration registers for polling_aswitch.
...
;               CUR_PP
;
_LoadConfig_polling_aswitch:
 LoadConfig_polling_aswitch:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_polling_aswitch_Bank0
    mov     X, <LoadConfigTBL_polling_aswitch_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_polling_aswitch_Bank1
    mov     X, <LoadConfigTBL_polling_aswitch_Bank1
