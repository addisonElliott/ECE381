...
export LoadConfigTBL_polling_aswitch_Bank1
export LoadConfigTBL_polling_aswitch_Bank0
export LoadConfigTBL_polling_aswitch_Ordered
AREA lit(rom, rel)
LoadConfigTBL_polling_aswitch_Bank0:
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_polling_aswitch_Bank1:
...
LoadConfigTBL_polling_aswitch_Ordered:
