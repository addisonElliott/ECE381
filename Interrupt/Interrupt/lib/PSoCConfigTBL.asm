...
export LoadConfigTBL_interrupt_Bank1
export LoadConfigTBL_interrupt_Bank0
export LoadConfigTBL_interrupt_Ordered
AREA lit(rom, rel)
LoadConfigTBL_interrupt_Bank0:
...
LoadConfigTBL_interrupt_Ordered:
