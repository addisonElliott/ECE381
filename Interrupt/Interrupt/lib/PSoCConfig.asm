...
export LoadConfig_interrupt
export _LoadConfig_interrupt
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_interrupt
	lcall	LoadConfigTBL_interrupt_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration interrupt
;
;    Load configuration registers for interrupt.
...
;               CUR_PP
;
_LoadConfig_interrupt:
 LoadConfig_interrupt:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_interrupt_Bank0
    mov     X, <LoadConfigTBL_interrupt_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_interrupt_Bank1
    mov     X, <LoadConfigTBL_interrupt_Bank1
