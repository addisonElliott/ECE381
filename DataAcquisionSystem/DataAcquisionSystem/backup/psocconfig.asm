...
export LoadConfig_DataAcqSystem
export _LoadConfig_DataAcqSystem
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_DataAcqSystem
	lcall	LoadConfigTBL_DataAcqSystem_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration DataAcqSystem
;
;    Load configuration registers for DataAcqSystem.
...
;               CUR_PP
;
_LoadConfig_DataAcqSystem:
 LoadConfig_DataAcqSystem:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_DataAcqSystem_Bank0
    mov     X, <LoadConfigTBL_DataAcqSystem_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_DataAcqSystem_Bank1
    mov     X, <LoadConfigTBL_DataAcqSystem_Bank1
