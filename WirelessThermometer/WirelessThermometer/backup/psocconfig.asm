...
export LoadConfig_wirelessthermometer
export _LoadConfig_wirelessthermometer
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_wirelessthermometer
	lcall	LoadConfigTBL_wirelessthermometer_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration wirelessthermometer
;
;    Load configuration registers for wirelessthermometer.
...
;               CUR_PP
;
_LoadConfig_wirelessthermometer:
 LoadConfig_wirelessthermometer:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_wirelessthermometer_Bank0
    mov     X, <LoadConfigTBL_wirelessthermometer_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_wirelessthermometer_Bank1
    mov     X, <LoadConfigTBL_wirelessthermometer_Bank1
