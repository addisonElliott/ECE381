...
export LoadConfigTBL_wirelessthermometer_Bank1
export LoadConfigTBL_wirelessthermometer_Bank0
export LoadConfigTBL_wirelessthermometer_Ordered
AREA lit(rom, rel)
LoadConfigTBL_wirelessthermometer_Bank0:
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_wirelessthermometer_Bank1:
;  Instance name ADCINC, User Module ADCINC
;       Instance name ADCINC, Block Name ADC1(ASC10)
;       Instance name ADCINC, Block Name ADC2(ASD20)
;       Instance name ADCINC, Block Name PWM(DBB00)
...
LoadConfigTBL_wirelessthermometer_Ordered:
