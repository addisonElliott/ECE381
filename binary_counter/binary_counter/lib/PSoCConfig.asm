...
export LoadConfig_binary_counter
export _LoadConfig_binary_counter
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_binary_counter
	lcall	LoadConfigTBL_binary_counter_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration binary_counter
;
;    Load configuration registers for binary_counter.
...
;               CUR_PP
;
_LoadConfig_binary_counter:
 LoadConfig_binary_counter:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_binary_counter_Bank0
    mov     X, <LoadConfigTBL_binary_counter_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_binary_counter_Bank1
    mov     X, <LoadConfigTBL_binary_counter_Bank1
