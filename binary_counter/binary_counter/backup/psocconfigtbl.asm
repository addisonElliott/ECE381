...
export LoadConfigTBL_binary_counter_Bank1
export LoadConfigTBL_binary_counter_Bank0
export LoadConfigTBL_binary_counter_Ordered
AREA lit(rom, rel)
LoadConfigTBL_binary_counter_Bank0:
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_binary_counter_Bank1:
...
LoadConfigTBL_binary_counter_Ordered:
