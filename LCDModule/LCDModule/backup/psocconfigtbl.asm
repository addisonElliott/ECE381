...
export LoadConfigTBL_lcdmodule_Bank1
export LoadConfigTBL_lcdmodule_Bank0
export LoadConfigTBL_lcdmodule_Ordered
AREA lit(rom, rel)
LoadConfigTBL_lcdmodule_Bank0:
...
LoadConfigTBL_lcdmodule_Ordered:
