...
export LoadConfig_lcdmodule
export _LoadConfig_lcdmodule
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_lcdmodule
	lcall	LoadConfigTBL_lcdmodule_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration lcdmodule
;
;    Load configuration registers for lcdmodule.
...
;               CUR_PP
;
_LoadConfig_lcdmodule:
 LoadConfig_lcdmodule:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_lcdmodule_Bank0
    mov     X, <LoadConfigTBL_lcdmodule_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_lcdmodule_Bank1
    mov     X, <LoadConfigTBL_lcdmodule_Bank1
