...
export LoadConfig_blink_led
export _LoadConfig_blink_led
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_blink_led
	lcall	LoadConfigTBL_blink_led_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration blink_led
;
;    Load configuration registers for blink_led.
...
;               CUR_PP
;
_LoadConfig_blink_led:
 LoadConfig_blink_led:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_blink_led_Bank0
    mov     X, <LoadConfigTBL_blink_led_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_blink_led_Bank1
    mov     X, <LoadConfigTBL_blink_led_Bank1
