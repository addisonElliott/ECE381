...
export LoadConfigTBL_blink_led_Bank1
export LoadConfigTBL_blink_led_Bank0
export LoadConfigTBL_blink_led_Ordered
AREA lit(rom, rel)
LoadConfigTBL_blink_led_Bank0:
...
LoadConfigTBL_blink_led_Ordered:
