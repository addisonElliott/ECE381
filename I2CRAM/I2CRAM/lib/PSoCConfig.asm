...
export LoadConfig_i2cram
export _LoadConfig_i2cram
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_i2cram
	lcall	LoadConfigTBL_i2cram_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration i2cram
;
;    Load configuration registers for i2cram.
...
_LoadConfig_i2cram:
 LoadConfig_i2cram:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_i2cram_Bank0
    mov     X, <LoadConfigTBL_i2cram_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_i2cram_Bank1
    mov     X, <LoadConfigTBL_i2cram_Bank1
