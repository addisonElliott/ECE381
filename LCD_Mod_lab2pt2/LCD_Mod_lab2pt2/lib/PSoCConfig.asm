...
export LoadConfig_lcd_mod_lab2pt2
export _LoadConfig_lcd_mod_lab2pt2
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_lcd_mod_lab2pt2
	lcall	LoadConfigTBL_lcd_mod_lab2pt2_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration lcd_mod_lab2pt2
;
;    Load configuration registers for lcd_mod_lab2pt2.
...
;               CUR_PP
;
_LoadConfig_lcd_mod_lab2pt2:
 LoadConfig_lcd_mod_lab2pt2:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_lcd_mod_lab2pt2_Bank0
    mov     X, <LoadConfigTBL_lcd_mod_lab2pt2_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_lcd_mod_lab2pt2_Bank1
    mov     X, <LoadConfigTBL_lcd_mod_lab2pt2_Bank1
