...
export LoadConfigTBL_lcd_mod_lab2pt2_Bank1
export LoadConfigTBL_lcd_mod_lab2pt2_Bank0
export LoadConfigTBL_lcd_mod_lab2pt2_Ordered
AREA lit(rom, rel)
LoadConfigTBL_lcd_mod_lab2pt2_Bank0:
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_lcd_mod_lab2pt2_Bank1:
;  Instance name LCD, User Module LCD
...
LoadConfigTBL_lcd_mod_lab2pt2_Ordered:
;  Ordered Global Register values
	...
	M8C_SetBank1
	mov	reg[04h], 16h		; Port_1_DriveMode_0 register (PRT1DM0)
	mov	reg[05h], e9h		; Port_1_DriveMode_1 register (PRT1DM1)
	M8C_SetBank0
	mov	reg[07h], c9h		; Port_1_DriveMode_2 register (PRT1DM2)
