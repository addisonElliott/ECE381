...
export LoadConfig_pollswitch
export _LoadConfig_pollswitch
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_pollswitch
	lcall	LoadConfigTBL_pollswitch_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration pollswitch
;
;    Load configuration registers for pollswitch.
...
;               CUR_PP
;
_LoadConfig_pollswitch:
 LoadConfig_pollswitch:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_pollswitch_Bank0
    mov     X, <LoadConfigTBL_pollswitch_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_pollswitch_Bank1
    mov     X, <LoadConfigTBL_pollswitch_Bank1
