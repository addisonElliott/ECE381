...
export LoadConfigTBL_pollswitch_Bank1
export LoadConfigTBL_pollswitch_Bank0
export LoadConfigTBL_pollswitch_Ordered
AREA lit(rom, rel)
LoadConfigTBL_pollswitch_Bank0:
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_pollswitch_Bank1:
...
LoadConfigTBL_pollswitch_Ordered:
